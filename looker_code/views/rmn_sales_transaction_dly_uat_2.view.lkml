view: rmn_sales_transaction_dly_uat_2{
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sap-rmn-acc-wawa-dev-mg.rmn_accel_dm.rmn_sales_transaction_dly` ;;
...
#start date of the previous period
  ...
  #########test1 : Abhi
  dimension: campaign_name1 {
    type: string
    sql:  ${TABLE}.campaign_name   AND  ${is_current_period} = true;;
