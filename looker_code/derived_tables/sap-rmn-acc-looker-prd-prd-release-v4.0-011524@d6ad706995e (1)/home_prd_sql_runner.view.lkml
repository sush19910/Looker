view: home_prd_sql_runner{
  derived_table: {
    sql: select
      ...
      from `sap-rmn-acc-wawa-prd-mg.rmn_accel_dm.rmn_sales_transaction_dly`
      ...
      from
      `sap-rmn-acc-wawa-prd-mg.rmn_accel_dm.rmn_kiosk_sales_transaction_dly`
