---
- dashboard: onsite__offsite_report
  title: On-Site / Off-Site Report
  layout: newspaper
  ...
  - title: IMPRESSIONS
    name: IMPRESSIONS
    model: rmn_sales_transaction_wawa_dly
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [rmn_sales_transaction_dly.impressions_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - _kind_hint: measure
      _type_hint: number
      based_on: rmn_sales_transaction_dly.impressions
      expression: ''
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.impressions_sum
      based_on: rmn_sales_transaction_dly.impressions_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Impressions
        Sum
      source_field: rmn_sales_transaction_dly.impressions_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_impressions_sum
      value_format:
      value_format_name: percent_0
    ...
    listen:
      Tactic: rmn_sales_transaction_dly.Tactic
      Reporting Period: rmn_sales_transaction_dly.transaction_date
      Channel: rmn_sales_transaction_dly.channel
      'Advertiser ': rmn_sales_transaction_dly.supplier_name
      Brand: rmn_sales_transaction_dly.brand
      Campaign: rmn_sales_transaction_dly.campaign_name
      Product: rmn_sales_transaction_dly.productUPC
    row: 0
    col: 0
    width: 6
    height: 3
  - title: CLICKS
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [rmn_sales_transaction_dly.clicks_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - _kind_hint: measure
    ...
    - _kind_hint: measure
      _type_hint: number
      based_on: rmn_sales_transaction_dly.clicks
      expression: ''
      label: Sum of Clicks
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.clicks_sum
      based_on: rmn_sales_transaction_dly.clicks_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Clicks Sum
      source_field: rmn_sales_transaction_dly.clicks_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_clicks_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: UNIQUE IMPRESSIONS
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [rmn_sales_transaction_dly.unique_impressions_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - _kind_hint: measure
    ...
    - _kind_hint: measure
      _type_hint: number
      based_on: rmn_sales_transaction_dly.unique_impressions
      expression: ''
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.unique_impressions_sum
      based_on: rmn_sales_transaction_dly.unique_impressions_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Unique Impressions
        Sum
      source_field: rmn_sales_transaction_dly.unique_impressions_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_unique_impressions_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: CTR
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_clicks, sum_of_impressions, rmn_sales_transaction_dly.ctr_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - _kind_hint: measure
  ...
  - title: AD SPEND
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_ad_spend, rmn_sales_transaction_dly.ad_spend_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - _kind_hint: measure
    ...
    - category: measure
      ...
      value_format:
      value_format_name: ''
      based_on: rmn_sales_transaction_dly.ad_spend
      _kind_hint: measure
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.ad_spend_sum
      based_on: rmn_sales_transaction_dly.ad_spend_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Ad Spend Sum
      source_field: rmn_sales_transaction_dly.ad_spend_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_ad_spend_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: REVENUE
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [rmn_sales_transaction_dly.revenue_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - _kind_hint: measure
    ...
    - category: measure
      ...
      based_on: rmn_sales_transaction_dly.revenue
      _kind_hint: measure
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.revenue_sum
      based_on: rmn_sales_transaction_dly.revenue_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Revenue Sum
      source_field: rmn_sales_transaction_dly.revenue_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_revenue_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: CONVERSIONS
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [rmn_sales_transaction_dly.conversion_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - _kind_hint: measure
    ...
    - _kind_hint: measure
      _type_hint: number
      based_on: rmn_sales_transaction_dly.conversion
      expression: ''
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.conversion_sum
      based_on: rmn_sales_transaction_dly.conversion_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Conversion Sum
      source_field: rmn_sales_transaction_dly.conversion_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_conversion_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: ROAS
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_revenue, sum_of_ad_spend, rmn_sales_transaction_dly.roas_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.roas_sum
      based_on: rmn_sales_transaction_dly.roas_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Roas Sum
      source_field: rmn_sales_transaction_dly.roas_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_roas_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: UNITS SOLD
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_units_sold, rmn_sales_transaction_dly.units_sold_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    - _kind_hint: measure
      _type_hint: number
      based_on: rmn_sales_transaction_dly.units_sold
      expression: ''
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.units_sold_sum
      based_on: rmn_sales_transaction_dly.units_sold_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Units Sold Sum
      source_field: rmn_sales_transaction_dly.units_sold_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_units_sold_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: TRANSACTIONS
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_transactions, rmn_sales_transaction_dly.transactions_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    - _kind_hint: measure
      _type_hint: number
      based_on: rmn_sales_transaction_dly.transactions
      expression: ''
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.transactions_sum
      based_on: rmn_sales_transaction_dly.transactions_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Transactions
        Sum
      source_field: rmn_sales_transaction_dly.transactions_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_transactions_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: REMAINING  WALLET
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_budget, rmn_sales_transaction_dly.budget_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    - _kind_hint: measure
      _type_hint: number
      based_on: rmn_sales_transaction_dly.budget
      expression: ''
      label: Sum of Budget
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.budget_sum
      based_on: rmn_sales_transaction_dly.budget_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Budget Sum
      source_field: rmn_sales_transaction_dly.budget_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_budget_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: CVR
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_conversion, sum_of_clicks, rmn_sales_transaction_dly.conversion_rate_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    - category: measure
      ...
      based_on: rmn_sales_transaction_dly.conversion_rate
      _kind_hint: measure
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.conversion_rate_sum
      based_on: rmn_sales_transaction_dly.conversion_rate_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Conversion Rate
        Sum
      source_field: rmn_sales_transaction_dly.conversion_rate_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_conversion_rate_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: CPT
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_transactions, sum_of_impressions, sum_of_ad_spend, sum_of_cpt,
      average_of_cpt, rmn_sales_transaction_dly.cpt_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    - _kind_hint: measure
      _type_hint: number
      based_on: rmn_sales_transaction_dly.cpt
      expression: ''
      label: Sum of Cpt
      measure: sum_of_cpt
      type: sum
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.cpt_sum
      based_on: rmn_sales_transaction_dly.cpt_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Cpt Sum
      source_field: rmn_sales_transaction_dly.cpt_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_cpt_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: CPC
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_clicks, sum_of_ad_spend, rmn_sales_transaction_dly.cpc_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.cpc_sum
      based_on: rmn_sales_transaction_dly.cpc_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Cpc Sum
      source_field: rmn_sales_transaction_dly.cpc_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_cpc_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: CPM
    ...
    explore: rmn_sales_transaction_dly
    type: single_value
    fields: [sum_of_ad_spend, sum_of_impressions, rmn_sales_transaction_dly.cpm_sum]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    - _kind_hint: measure
      _type_hint: number
      args:
      - rmn_sales_transaction_dly.cpm_sum
      based_on: rmn_sales_transaction_dly.cpm_sum
      calculation_type: percent_difference_from_previous
      category: table_calculation
      label: Percent change from previous - Rmn Sales Transaction Dly Cpm Sum
      source_field: rmn_sales_transaction_dly.cpm_sum
      table_calculation: percent_change_from_previous_rmn_sales_transaction_dly_cpm_sum
      value_format:
      value_format_name: percent_0
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: Campaign Spend, Revenue and ROAS
    ...
    explore: rmn_sales_transaction_dly
    type: looker_column
    fields: [rmn_sales_transaction_dly.transaction_date, sum_of_ad_spend, sum_of_revenue]
    fill_fields: [rmn_sales_transaction_dly.transaction_date]
    sorts: [rmn_sales_transaction_dly.transaction_date]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    width: 24
    height: 7
  - title: Spend  & Revenue by Channel
    name: Spend  & Revenue by Channel
    model: rmn_sales_transaction_wawa_dly
    explore: rmn_sales_transaction_dly
    type: looker_bar
    fields: [rmn_sales_transaction_dly.channel, sum_of_ad_spend, sum_of_revenue]
    filters:
      rmn_sales_transaction_dly.timeframes: Selected Period
    sorts: [rmn_sales_transaction_dly.channel desc]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: measure
    ...
    color_application:
      ...
      options:
        steps: 5
    y_axes: [{label: Spend($) and Revenue($), orientation: bottom, series: [{axisId: sum_of_ad_spend,
            id: sum_of_ad_spend, name: Spend($)}, {axisId: sum_of_revenue, id: sum_of_revenue,
            name: Revenue($)}], showLabels: false, showValues: true, valueFormat: "$0,\\\
          K", unpinAxis: false, tickDensity: custom, tickDensityCustom: 11, type: linear}]
    x_axis_label: ''
    x_axis_zoom: true
    y_axis_zoom: true
    series_colors:
    ...
    advanced_vis_config: |-
      {
        ...
        tooltip: {
          ...
          format: '<span style="font-size: 1em; font-weight: medium;">CHANNEL: {key}</span><br/>{#each points}<span style="color:{color}; font-weight: medium;">\u25CF {series.name}: </span><span style="font-weight: medium;">${y:,.2f}</span><br/>{/each}',
  ...
  - title: Units Sold by Channel
    ...
    filters:
      rmn_sales_transaction_dly.timeframes: Selected Period
    sorts: [rmn_sales_transaction_dly.channel]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: measure
  ...
  - title: Performance by Placement
    ...
    explore: rmn_sales_transaction_dly
    type: looker_grid
    fields: [rmn_sales_transaction_dly.channel, rmn_sales_transaction_dly.Tactic,
      rmn_sales_transaction_dly.placement, spend, impression, sum_of_clicks,
      sum_of_unique_impressions, sum_of_units_sold_2, revenue, sum_of_transactions]
    sorts: [rmn_sales_transaction_dly.placement]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
    ...
    pinned_columns:
      "$$$_row_numbers_$$$": left
    column_order: ["$$$_row_numbers_$$$", rmn_sales_transaction_dly.placement,
      rmn_sales_transaction_dly.channel, rmn_sales_transaction_dly.Tactic,
      impression, sum_of_unique_impressions, sum_of_clicks, ctr_1, sum_of_units_sold_2,
      sum_of_transactions, spend, revenue, roas_1]
    show_totals: true
    show_row_totals: true
    truncate_header: false
    minimum_column_width: 75
    series_labels:
      rmn_sales_transaction_dly.placement: Placement
    ...
    series_cell_visualizations:
      sum_of_revenue:
        is_active: false
    series_text_format:
      rmn_sales_transaction_dly.placement:
        align: left
      spend:
        align: left
      impression:
    ...
    label_type: labPer
    inner_radius: 55
    hidden_fields: [rmn_sales_transaction_dly.timeframes]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_y_axis_labels: true
    show_y_axis_ticks: true
  ...
  - title: Revenue by Brand
    ...
    type: looker_grid
    fields: [rmn_sales_transaction_dly.channel, rmn_sales_transaction_dly.Tactic,
      rmn_sales_transaction_dly.brand, sum_of_ad_spend_1, sum_of_impressions_2,
    ...
    - category: measure
      expression: ''
      label: Sum of Roas
      based_on: rmn_sales_transaction_dly.roas
      _kind_hint: measure
      measure: sum_of_roas
      type: average
      _type_hint: number
    ...
    conditional_formatting_include_nulls: false
    show_sql_query_menu_options: false
    column_order: ["$$$_row_numbers_$$$", rmn_sales_transaction_dly.brand, rmn_sales_transaction_dly.channel,
      rmn_sales_transaction_dly.Tactic, sum_of_impressions_2, sum_of_units_sold_2,
      sum_of_ad_spend_1, sum_of_revenue_1, roas]
    show_totals: true
    show_row_totals: true
    truncate_header: false
    minimum_column_width: 75
    series_labels:
      ...
      roas: ROAS($)
      rmn_sales_transaction_dly.impressions_sum: Impressions
      rmn_sales_transaction_dly.revenue_sum: Revenue($)
      rmn_sales_transaction_dly.ad_spend_sum: Spend($)
      rmn_sales_transaction_dly.clicks_sum: Clicks
      rmn_sales_transaction_dly.roas_sum: ROAS($)
      rmn_sales_transaction_dly.units_sold_sum: Units Sold
    ...
    series_cell_visualizations:
      sum_of_revenue:
        is_active: false
    series_text_format:
      rmn_sales_transaction_dly.brand: {}
      roas: {}
      sum_of_ad_spend_1:
        align: left
  ...
  - title: Units Sold by Product
    ...
    type: looker_grid
    fields: [rmn_sales_transaction_dly.channel, rmn_sales_transaction_dly.Tactic,
      rmn_sales_transaction_dly.brand, rmn_sales_transaction_dly.product_name,
    ...
    pinned_columns:
      "$$$_row_numbers_$$$": left
      rmn_sales_transaction_dly.product_name: left
      rmn_sales_transaction_dly.channel: left
      rmn_sales_transaction_dly.Tactic: left
      sum_of_impressions_2: left
      sum_of_units_sold_2: left
      sum_of_ad_spend_1: left
    column_order: ["$$$_row_numbers_$$$", rmn_sales_transaction_dly.product_name,
      rmn_sales_transaction_dly.channel, rmn_sales_transaction_dly.Tactic,
      sum_of_impressions_2, sum_of_units_sold_2, sum_of_ad_spend_1, sum_of_revenue_1,
      roas]
    show_totals: true
    show_row_totals: true
    truncate_header: false
    ...
    series_labels:
      ...
      sum_of_revenue_1: Revenue($)
      sum_of_units_sold_2: Units Sold
      rmn_sales_transaction_dly.product_name: Product
    series_cell_visualizations:
      sum_of_revenue:
        is_active: false
    series_text_format:
    ...
    defaults_version: 1
    hidden_pivots: {}
    hidden_fields: [rmn_sales_transaction_dly.timeframes, rmn_sales_transaction_dly.brand]
    title_hidden: true
    listen:
      Tactic: rmn_sales_transaction_dly.Tactic
      Reporting Period: rmn_sales_transaction_dly.transaction_date
  ...
  - title: Revenue by Brand
    ...
    explore: rmn_sales_transaction_dly
    type: looker_pie
    fields: [rmn_sales_transaction_dly.brand, sum_of_ad_spend_1, sum_of_impressions_2,
      revenue, sum_of_units_sold_2]
    sorts: [revenue desc]
    limit: 10
    column_limit: 50
    dynamic_fields:
    ...
    conditional_formatting_include_nulls: false
    show_sql_query_menu_options: false
    column_order: ["$$$_row_numbers_$$$", rmn_sales_transaction_dly.brand, sum_of_ad_spend_1,
    ...
    defaults_version: 1
    hidden_pivots: {}
    hidden_fields: [rmn_sales_transaction_dly.timeframes, sum_of_impressions_2,
  ...
  - title: Units Sold by Product
    ...
    explore: rmn_sales_transaction_dly
    type: looker_pie
    fields: [rmn_sales_transaction_dly.timeframes, sum_of_ad_spend_1, sum_of_impressions_2,
      sum_of_revenue_1, units_sold, rmn_sales_transaction_dly.product_name]
    filters:
      rmn_sales_transaction_dly.timeframes: Selected Period
    ...
    series_column_widths:
      rmn_sales_transaction_dly.product_name: 244.33299999999997
    series_cell_visualizations:
      sum_of_revenue:
        is_active: false
    series_text_format:
    ...
    defaults_version: 1
    hidden_pivots: {}
    hidden_fields: [rmn_sales_transaction_dly.timeframes, sum_of_ad_spend_1,
    ...
    width: 12
    height: 7
  - title: Spend & Revenue by Tactic
    name: Spend & Revenue by Tactic
    model: rmn_sales_transaction_wawa_dly
    explore: rmn_sales_transaction_dly
    type: looker_bar
    fields: [sum_of_ad_spend, sum_of_revenue, rmn_sales_transaction_dly.Tactic]
    filters:
      rmn_sales_transaction_dly.timeframes: Selected Period
    sorts: [rmn_sales_transaction_dly.Tactic]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: measure
    ...
    color_application:
      ...
      options:
        steps: 5
    y_axes: [{label: '', orientation: bottom, series: [{axisId: sum_of_ad_spend, id: sum_of_ad_spend,
            name: Spend($)}, {axisId: sum_of_revenue, id: sum_of_revenue, name: Sum
              of Revenue}], showLabels: false, showValues: true, valueFormat: "$0,\\\
          K", unpinAxis: false, tickDensity: custom, tickDensityCustom: 10, type: linear}]
    x_axis_label: ''
    x_axis_zoom: true
    y_axis_zoom: true
    hide_legend: false
  ...
  - title: Units Sold by Tactic
    ...
    explore: rmn_sales_transaction_dly
    type: looker_bar
    fields: [sum_of_ad_spend, sum_of_revenue, units_sold, rmn_sales_transaction_dly.Tactic]
    filters:
      rmn_sales_transaction_dly.timeframes: Selected Period
  ...
  - title: ROAS by Tactic
    ...
    explore: rmn_sales_transaction_dly
    type: looker_bar
    fields: [sum_of_ad_spend, sum_of_revenue, sum_of_units_sold, rmn_sales_transaction_dly.Tactic]
    filters:
      rmn_sales_transaction_dly.timeframes: Selected Period
    sorts: [sum_of_ad_spend desc 0]
    limit: 500
  ...
  - name: Reporting Period
    ...
    type: field_filter
    default_value: 2025/01/01 to 2025/01/17
    ...
    explore: rmn_sales_transaction_dly
    listens_to_filters: []
    field: rmn_sales_transaction_dly.transaction_date
  - name: Channel
    title: Channel
    type: field_filter
    default_value: ''
    ...
    model: rmn_sales_transaction_wawa_dly
    explore: rmn_sales_transaction_dly
    listens_to_filters: [DATE, Product, Campaign, Brand, 'Advertiser ', Tactic, Reporting
        Period]
    field: rmn_sales_transaction_dly.channel
  - name: Tactic
    title: Tactic
    type: field_filter
    default_value: ''
    ...
    model: rmn_sales_transaction_wawa_dly
    explore: rmn_sales_transaction_dly
    listens_to_filters: [Product, Campaign, Brand, 'Advertiser ', Channel, Reporting
        Period]
    field: rmn_sales_transaction_dly.Tactic
  - name: 'Advertiser '
    title: 'Advertiser '
    type: field_filter
    default_value: ''
    ...
    model: rmn_sales_transaction_wawa_dly
    explore: rmn_sales_transaction_dly
    listens_to_filters: [Product, Campaign, Brand, Tactic, Channel, Reporting Period]
    field: rmn_sales_transaction_dly.supplier_name
  - name: Brand
    title: Brand
    type: field_filter
    default_value: ''
    ...
    model: rmn_sales_transaction_wawa_dly
    explore: rmn_sales_transaction_dly
    listens_to_filters: [DATE, Product, Campaign, 'Advertiser ', Tactic, Channel,
      Reporting Period]
    field: rmn_sales_transaction_dly.brand
  - name: Campaign
    title: Campaign
    type: field_filter
    default_value: ''
    ...
    model: rmn_sales_transaction_wawa_dly
    explore: rmn_sales_transaction_dly
    listens_to_filters: [DATE, Product, Brand, 'Advertiser ', Tactic, Channel, Reporting
        Period]
    field: rmn_sales_transaction_dly.campaign_name
  - name: Product
    title: Product
    type: field_filter
    default_value: ''
    ...
    model: rmn_sales_transaction_wawa_dly
    explore: rmn_sales_transaction_dly
    listens_to_filters: [Campaign, Brand, 'Advertiser ', Tactic, Channel, Reporting
        Period]
    field: rmn_sales_transaction_dly.productUPC
